...
import type { MealType, StoredMeal } from '../../shared/schemas';

interface RecipeDetailModalProps {
  open: boolean;
  onClose: () => void;
  recipe: StoredMeal | null;
  mealType: MealType | null;
  isDark: boolean;
}

export default function RecipeDetailModal({ open, onClose, recipe, mealType, isDark }: RecipeDetailModalProps) {
