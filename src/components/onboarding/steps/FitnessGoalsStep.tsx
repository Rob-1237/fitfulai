...
import type { ActivityLevel, NutritionGoal } from '../../../shared/schemas';
import type { StepProps } from '../types';

export default function FitnessGoalsStep({ data, updateData }: StepProps) {
  ...
  const nutritionGoals: Array<{ value: NutritionGoal; label: string; emoji: string; desc: string }> = [
  ...
  const activityLevels: Array<{ value: ActivityLevel; label: string; desc: string }> = [
